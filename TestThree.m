% Test three of the seven specified functions for the 2018 matlab project
...
% Once setup is complete you can test code by typing TestThree from
...
disp(['Your total functionality mark for these 3 functions is ' num2str(totalMark) '/9'])
